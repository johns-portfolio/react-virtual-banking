...
type MenuName = 'About' | 'Discover' | 'Services' | 'Sign Up'
...
const Header = () => {
  ...
  return (
    <div className="relative ">
      <div className="bg-gray-900 px-6 md:px-16 py-6 flex flex-row items-center justify-between text-gray-100">
        ...
        <div className="hidden md:flex flex-row items-center gap-4">
          ...
          <button className="bg-green-600 ml-10 px-6 py-2 rounded-3xl cursor-pointer hover:bg-green-500 transition-all">
            Sign In
          </button>
        </div>
        {!showPopupMenu && (
